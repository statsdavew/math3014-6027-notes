...
\begin{equation*}
\begin{split}
\mbox{RSS} & = \bY^{\mathrm{T}}\bY - 2^f\bar{y} -  2^f\sum_{i=1}^{p}\hat{\beta}_i^2 \\
...
b. $E(y_11) = \boldsymbol{x}_1^{\mathrm{T}}\boldsymbol{\beta}$, where $\boldsymbol{x}_1^{\mathrm{T}}$ is the row of the $X$ matrix corresponding to the first treatment and $\boldsymbol{\beta}$ are the regression coefficients. The estimator is given by
