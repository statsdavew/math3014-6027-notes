...
```
Checking that the function `opt-ni` matches \@ref(eq:opt-ni) as left as an exercise.
...
### Overall size of the experiment
...
cbind('Signal-to-noise' = snr, 'n' = opt_n(cv, p, snr, 3))
```
