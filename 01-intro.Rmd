...
Consider a linear statistical model^[In this course, we will almost always start with a statistical model which we wish to use to answer our scientific question.] for the response (see MATH2010):
...
### Stratification (or blocking) {#blocking}
