...
\NormalTok{ tidyr}\SpecialCharTok{::}\FunctionTok{pivot\_wider}\NormalTok{(tyre, }\AttributeTok{names\_from =}\NormalTok{ compound, }\AttributeTok{values\_from =}\NormalTok{ wear),}
 ...
 \AttributeTok{caption =} \StringTok{"Tyre experiment: wear measurements from tires made with four different rubber compounds."}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{tab:tyre-expt-data}Tyre experiment: wear measurements from tires made with four different rubber compounds.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
